...
* Export the processed data and visuals to Excel for easy presentation.

---

##  Key Features

* API-based data collection for accurate and real-time data.
* Data cleaning and transformation using Pandas.
* Exploratory Data Analysis (EDA) for understanding trends.
* Graphical insights using **Matplotlib**, **Seaborn**, and **Excel**.
* Visualizations include bar plots, heat maps, stacked bars, scatter plots, and pair plots.
...
**Visualization Tools:** Python (plots) 
...
4. **Run all cells** to perform the full analysis and generate visualizations.
   The cleaned dataset and results can be exported to Excel for reporting.

---

##  Visualizations Used

* **Bar Plot:** Compared average ratings by language.
* **Heat Map:** Analyzed correlation between rating, vote count, and popularity.
* **Stacked Bar:** Compared popularity categories and average ratings.
* **Scatter Plot:** Showed relationships between year, rating, and popularity.
* **Pair Plot:** Displayed multivariate relationships between rating, votes, and popularity.

---

##  Insights & Learnings

* Movies with higher **vote counts** tend to maintain consistent ratings.
* **Popularity** and **ratings** show a positive correlation in most decades.
* Certain genres consistently attract high popularity regardless of ratings.
* Visualization helps interpret audience preferences more effectively.
